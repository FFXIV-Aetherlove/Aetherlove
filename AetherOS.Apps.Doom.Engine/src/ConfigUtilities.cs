...
namespace ManagedDoom
{
    public static class ConfigUtilities
    {
        ...
        // AetherOS local modification: the engine derives its config and savegame paths from the host
        // process directory, which inside FFXIV is the game's own folder. The host sets this to the app's
        // storage folder before constructing Doom so saves never land next to ffxiv_dx11.exe.
