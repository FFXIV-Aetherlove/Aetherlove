...
/// <summary>Match effect - Synthwave Sunset: a retro outrun scene with a perspective neon grid floor, sliced gradient sun, and two glowing avatars.</summary>
public sealed class MatchSynthwaveScreen : IMatchEffect
{
    ...
    public MatchSynthwaveScreen(LoveRouter router)
    {
        _router = router;
    }
