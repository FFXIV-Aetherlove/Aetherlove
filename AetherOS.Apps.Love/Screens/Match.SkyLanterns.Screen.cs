...
/// <summary>Match effect - Sky Lanterns: glowing paper lanterns rise together toward the top under a starry night.</summary>
public sealed class MatchSkyLanternsScreen : IMatchEffect
{
    ...
    public MatchSkyLanternsScreen(LoveRouter router)
    {
        _router = router;
    }
