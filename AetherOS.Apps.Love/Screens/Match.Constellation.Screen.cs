...
public sealed class MatchConstellationScreen : IMatchEffect
{
    ...
    public MatchConstellationScreen(LoveRouter router)
    {
        _router = router;
    }
    ...
    /// <summary>Fills the heart curve vertices, centred on <paramref name="center"/> and starting at the bottom tip for symmetric trace reveal.</summary>
