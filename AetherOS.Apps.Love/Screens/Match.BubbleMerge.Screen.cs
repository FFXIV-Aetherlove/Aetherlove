...
public sealed class MatchBubbleMergeScreen : IMatchEffect
{
    ...
    public MatchBubbleMergeScreen(LoveRouter router)
    {
        _router = router;
    }
    ...
    /// <summary>Translucent soap bubble with tinted fill, bright rim, and offset white highlight.</summary>
    ...
    /// <summary>Bubble shell around an avatar, with no inner fill so the avatar reads clearly.</summary>
