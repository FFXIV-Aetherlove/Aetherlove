...
public partial class MyProfileScreen
{
    ...
    // Lazy: Lumina labels need UiHost.DataManager to be live.
    ...
    public MyProfileScreen(LoveShell shell, ProfileScreen profileScreen, AetherHubContext hubClient,
    ...
    private void LoadFromServer()
    {
        ...
        _ = Task.Run(async () =>
        {
            ...
            catch (Exception ex)
            {
                ...
                UiHost.Log.Warning(ex, "[MyProfileScreen] GetOnboardingStateAsync failed.");
            }
            finally
            {
    ...
    private void HydrateServerPhotos(OnboardingPhotoDto[] photos)
    {
        ...
        var cacheDir = Path.Combine(UiHost.PluginInterface.ConfigDirectory.FullName, MyProfilePhotoCacheDir);
        try { Directory.CreateDirectory(cacheDir); }
        catch (Exception ex)
        {
            UiHost.Log.Warning(ex, "[MyProfileScreen] Failed to create photo cache dir.");
            return;
        }
        ...
        foreach (var photo in photos)
        {
            ...
            {
                UiHost.Log.Warning(ex, $"[MyProfileScreen] Failed to hydrate photo slot {photo.Order}.");
            }
        }
    }
    ...
    private void SaveToServer()
    {
        ...
        _ = Task.Run(async () =>
        {
            ...
            catch (Exception ex)
            {
                ...
                UiHost.Log.Warning(ex, "[MyProfileScreen] Save to server failed.");
            }
            finally
            {
