...
/// <summary>Match effect "Classic": a dimming overlay, confetti, and two avatars sliding in to meet beneath the title.</summary>
public sealed class MatchClassicScreen : IMatchEffect
{
    ...
    public MatchClassicScreen(LoveRouter router)
    {
        _router = router;
    }
