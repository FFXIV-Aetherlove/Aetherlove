...
public sealed class MatchDnaHelixScreen : IMatchEffect
{
    ...
    public MatchDnaHelixScreen(LoveRouter router)
    {
        _router = router;
    }
    ...
    /// <summary>Returns strand X at normalised height <paramref name="n"/> with a phase offset (180-degree strand uses <c>MathF.PI</c>).</summary>
    ...
    /// <summary>Returns front-to-back depth (0..1, 1 = nearest viewer) from phase sine for 3D fading.</summary>
