...
/// <summary>Match effect - Treasure Chest: a wooden chest swings its lid open and bursts with golden rays, sparkles, and coins to reveal avatars as loot.</summary>
public sealed class MatchTreasureChestScreen : IMatchEffect
{
    ...
    public MatchTreasureChestScreen(LoveRouter router)
    {
        _router = router;
    }
