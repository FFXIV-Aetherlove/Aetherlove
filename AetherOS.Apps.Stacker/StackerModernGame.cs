...
/// <summary>The guideline-ruleset game model (the "Modern" mode): SRS rotation with real wall kicks,
/// hold, T-spin detection, back-to-back and combo scoring, lock-delay grace and a hard-drop lockout.
/// No drawing and no ImGui. Scores live in their own domain (ArcadeGame.StackerModern) because this
/// scoring is a different currency from the classic mode's; scoring constants MIRROR the server's
/// ArcadeScoreChecker.CheckStackerModern, tune both together or honest runs get flagged. The classic
/// StackerGame stays untouched beside it.
///
/// This engine, the skins and the Modern UI began as a community contribution: thank you, Aven
/// (github.com/Vavenn), for the SRS implementation, the T-spin detection and the sprite work that
/// made this mode real.</summary>
internal sealed class StackerModernGame
{
