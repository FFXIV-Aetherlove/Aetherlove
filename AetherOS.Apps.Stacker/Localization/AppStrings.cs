...
public static class AppStrings
{
    private static readonly IReadOnlyDictionary<string, string> En = new Dictionary<string, string>
    {
        ...
        ["os.stacker_control_movedown"] = "Move down",
        ["os.stacker_control_harddrop"] = "Instant drop",
        ["os.stacker_hold_label"] = "Hold",
        ["os.stacker_next_label"] = "Next",
        ["os.stacker_fx_tetris"] = "Tetris!",
        ["os.stacker_fx_b2b_tetris"] = "Back-to-Back Tetris!",
        ["os.stacker_fx_tspin"] = "T Spin",
        ["os.stacker_fx_mini"] = " Mini",
        ["os.stacker_fx_double"] = "Double ",
        ["os.stacker_fx_triple"] = "Triple ",
        ["os.stacker_fx_b2b_prefix"] = "Back-to-Back ",
        ["os.stacker_fx_combo"] = "{0} - Combo!",
        ["os.stacker_skin_retro"] = "Retro",
        ["os.stacker_skin_retro_green"] = "R.Green",
        ["os.stacker_skin_classic"] = "Classic",
        ["os.stacker_skin_arcade"] = "Arcade",
    };
