...
public sealed class MatchFireworkScreen : IMatchEffect
{
    ...
    public MatchFireworkScreen(ScreenRouter router)
    {
        _router = router;
    }
    ...
    /// <summary>Draws one firework over its lifetime and returns how much it lights the avatars this
    /// frame (0 before launch / after the bloom fades).</summary>
