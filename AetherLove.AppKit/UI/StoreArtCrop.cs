...
/// <summary>Which part of a product's picture a card shows, for every screen that draws one. Lives in
/// the shared kit rather than in the store, because the racing prize cards draw the same renders and a
/// second copy of these windows would drift from the art they were measured against.
///
/// <para>Which part a shelf card shows: A centred cover crop is right for a
...
/// sliver. Both are far more legible cropped to the part that carries the detail.</para></summary>
public static class StoreArtCrop
{
