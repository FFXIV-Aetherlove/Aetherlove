...
internal static class OsEs
{
    public static readonly System.Collections.Generic.Dictionary<string, string> Strings = new()
    {
        ...
        ["os.tour_pages_body"] = "Aquí viven tus apps, repartidas en páginas. Desliza a izquierda y derecha para cambiar; los puntos indican dónde estás. Si llevas un icono al borde de la pantalla, la página pasa con él.",
        ...
        ["os.tour_dock_body"] = "La fila de abajo se queda en su sitio en todas las páginas. Ahí van tus favoritas: arrastra un icono dentro para tenerlo a un toque estés donde estés, y sácalo cuando cambies de idea.",
        ["os.tour_folders_title"] = "Carpetas",
        ["os.tour_folders_body"] = "Suelta un icono encima de otro y se convierten en una carpeta. Tócala para abrirla, renómbrala cuando quieras y arrastra una app fuera del panel para devolverla a la pantalla de inicio. Una carpeta vacía desaparece sola.",
        ["os.tour_addapps_title"] = "Más apps",
        ["os.tour_addapps_body"] = "Todo lo que has quitado sigue aquí, junto con tus otros plugins de Dalamud, que pueden estar en la pantalla de inicio como cualquier otra app.",
        ...
        ["os.tour_arrange_body"] = "Los iconos se arrastran en cualquier momento; no hay modo de edición que activar antes. Coge uno, llévalo a otra casilla, a otra página o a la fila de abajo, y suéltalo.",
        ...
        ["os.tour_newapps_body"] = "Cuando una actualización trae apps nuevas, se te ofrecen en vez de aparecer sin más: recibes una lista, eliges las que quieras y el resto se queda apartado hasta que las pidas. Un icono nuevo lleva una pequeña marca hasta que lo abres una vez.",
        ...
        ["os.app_aetherling_about"] = "Nadie quiere decir qué es esto.",
