...
internal static class OsDe
{
    public static readonly System.Collections.Generic.Dictionary<string, string> Strings = new()
    {
        ...
        ["os.tour_pages_body"] = "Hier leben deine Apps, verteilt auf Seiten. Wische nach links und rechts, um zu wechseln; die Punkte zeigen, wo du bist. Ziehst du ein Symbol an den Bildschirmrand, blättert die Seite mit um.",
        ...
        ["os.tour_dock_body"] = "Die untere Reihe bleibt auf jeder Seite stehen. Dort liegen deine Favoriten: zieh ein Symbol hinein, um es überall mit einem Tipp zu erreichen, und wieder heraus, wenn du es dir anders überlegst.",
        ["os.tour_folders_title"] = "Ordner",
        ["os.tour_folders_body"] = "Lass ein Symbol auf einem anderen los, und beide werden zu einem Ordner. Tippen öffnet ihn, umbenennen kannst du ihn jederzeit, und wer eine App aus dem Fenster herauszieht, legt sie zurück auf den Homescreen. Ein leerer Ordner verschwindet von selbst.",
        ["os.tour_addapps_title"] = "Mehr Apps",
        ["os.tour_addapps_body"] = "Alles, was du weggenommen hast, liegt weiterhin hier, zusammen mit deinen anderen Dalamud-Plugins, die genauso auf dem Homescreen stehen dürfen wie jede andere App.",
        ...
        ["os.tour_arrange_body"] = "Symbole lassen sich jederzeit ziehen, ganz ohne Bearbeitungsmodus. Aufnehmen, in eine andere Zelle, auf eine andere Seite oder in die untere Reihe tragen und loslassen.",
        ...
        ["os.tour_newapps_body"] = "Bringt ein Update neue Apps, werden sie dir angeboten statt einfach abgelegt: du bekommst eine Liste, suchst dir aus, was du willst, und der Rest bleibt aus dem Weg, bis du danach fragst. Ein neues Symbol trägt eine kleine Markierung, bis du es einmal geöffnet hast.",
        ...
        ["os.app_aetherling_about"] = "Niemand verrät, was das hier ist.",
