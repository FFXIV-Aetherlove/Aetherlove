...
public sealed class PetCatalogue
{
    ...
    private static readonly Dictionary<string, string> ArmsRefs = new(StringComparer.OrdinalIgnoreCase)
    {
        ...
        ["Driftwood Boomerang"] = "arm-boomerang",
        ["Seabreeze Kite"] = "arm-kite",
        ["Palmshade Cooler"] = "arm-cooler",
        ["Tidesand Pail"] = "arm-pail",
        ["Relay Baton"] = "arm-baton",
        ["Runner's Bidon"] = "arm-bidon",
        ["Pacer's Stopwatch"] = "arm-stopwatch",
        ["Trophy Cup"] = "arm-trophy",
        ["Winner's Medal"] = "arm-handmedal",
        ["Wayfinder Compass"] = "arm-compass",
        ["Voxel Sword"] = "arm-pixelsword",
        ["Voxel Torch"] = "arm-pixeltorch",
        ["Swirl Lollipop"] = "arm-lollipop",
        ["Nutkin's Acorn"] = "arm-acorn",
        ["Mulled Cider"] = "arm-cidermug",
        ["Aether Crystal"] = "arm-crystal",
        ["Deploy Fuel"] = "arm-coffee",
