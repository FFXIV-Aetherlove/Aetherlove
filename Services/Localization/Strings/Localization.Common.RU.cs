...
internal static class CommonRu
{
    public static readonly System.Collections.Generic.Dictionary<string, string> Strings = new()
    {
        ...
        ["common.recovery_intro"] = "В вашем аккаунте отсутствуют ключи шифрования, поэтому вы пока не можете отправлять и получать сообщения. Придумайте парольную фразу, чтобы создать их. Сохраните её надёжно, восстановить её невозможно.",
        ["common.recovery_button"] = "Включить защищённые сообщения",
        ["common.recovery_support"] = "Всё ещё не получается? Выйдите из аккаунта ниже или напишите нам в Discord.",
        ...
        ["common.modmsg_body"] = "Команда модерации отправила вам следующее:",
        ...
        ["common.sfw_gate_b2"] = "Видимые соски любого пола.",
        ["common.sfw_gate_b3"] = "Видимые лобковые волосы или области гениталий.",
        ["common.sfw_gate_b4"] = "Натуралистичные изображения крови, травм, ран или телесных повреждений.",
