...
internal static class HubErrorsFr
{
    public static readonly System.Collections.Generic.Dictionary<string, string> Strings = new()
    {
        ...
        ["huberror.peer_keys_missing"] = "Votre match n'a pas encore terminé la configuration du chat chiffré. Réessayez plus tard.",
        ...
        ["huberror.img_payload_invalid"] = "La photo n'a pas pu être téléversée. Veuillez resélectionner l'image.",
        ...
        ["huberror.report_reason_too_long"] = "La raison est trop longue (max {0} caractères).",
