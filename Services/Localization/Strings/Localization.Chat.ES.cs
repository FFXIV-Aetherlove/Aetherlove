...
internal static class ChatEs
{
    public static readonly System.Collections.Generic.Dictionary<string, string> Strings = new()
    {
        ...
        ["chat.search_estimate"] = "Esto puede tardar {0}-{1} segundos debido a la cantidad de conversaciones.",
        ["chat.search_rate_limited"] = "Demasiadas conversaciones para buscar a la vez. Inténtalo de nuevo en un minuto.",
