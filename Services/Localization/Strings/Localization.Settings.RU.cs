...
internal static class SettingsRu
{
    public static readonly System.Collections.Generic.Dictionary<string, string> Strings = new()
    {
        ...
        ["settings.menu_supporter"] = "Спонсор",
        ...
        ["settings.supporter_you_are_title"] = "Вы саппортер",
        ["settings.supporter_you_are_body"] = "Ваш аккаунт Patreon успешно привязан, и статус саппортера включён.",
        ["settings.supporter_nomember_title"] = "Подписка не найдена",
        ["settings.supporter_nomember_body"] = "Ваш аккаунт Patreon привязан, но активная подписка не найдена. Если вы только что оформили её, статус саппортера будет выдан автоматически в течение нескольких часов. Вы также можете отвязать аккаунт и попробовать снова, когда подписка на Patreon станет активной.",
        ["settings.supporter_not_entitled"] = "Активное членство пока не найдено. Если вы только что оформили подписку, роль будет выдана автоматически в течение нескольких часов.",
        ...
        ["settings.supporter_unavailable"] = "Привязка спонсоров сейчас недоступна. Загляните позже.",
        ...
        ["settings.supporter_title"] = "Станьте спонсором",
        ["settings.supporter_intro"] = "Вы можете финансово поддержать проект через наш Patreon. Все функции AetherLove бесплатны для всех, и ничто не находится и никогда не будет скрыто за платной стеной. Спонсоры просто получают искреннюю благодарность: более мягкие ограничения и пару сверкающих мелочей, наш способ сказать, что без вас мы бы не справились.",
        ...
        ["settings.supporter_perk_superlike_body"] = "Дайте человеку понять, что он вам действительно приглянулся. Он получит уведомление о вашем суперлайке, и если ответит взаимностью, пара создастся сразу.",
        ["settings.supporter_perk_rewinds_title"] = "5 возвратов в день",
        ["settings.supporter_perk_rewinds_body"] = "Свайпнули слишком рано? Отматывайте назад до 5 раз в день вместо одного.",
        ["settings.supporter_perk_analytics_title"] = "Более глубокая аналитика",
        ...
        ["settings.supporter_perk_badge_body"] = "Тег спонсора и маленькая звёздочка рядом с вашим именем. Тот самый тихий шик, заслуженный.",
        ["settings.supporter_how_heading"] = "Как это работает",
        ["settings.supporter_how_intro"] = "У нас есть три уровня по разной цене, чтобы вы выбрали то, что вам комфортно, и все они открывают ровно одни и те же бонусы. Ни один уровень не даёт больше другого.",
        ...
        ["settings.supporter_data_note"] = "Мы храним только ваш идентификатор пользователя Patreon и то, что вы участник нашей кампании. Мы никогда не храним ваше имя, почту или социальные аккаунты.",
        ["settings.sup_learn_title"] = "Поддержите AetherLove",
        ["settings.sup_learn_body"] = "Этот игрок поддерживает AetherLove. Хотите узнать, что даёт поддержка проекта? Дополнительные фото, суперлайки, стили имени, бонусная статистика и многое другое.",
        ["settings.sup_learn_more"] = "Подробнее",

        ["settings.sup_thanks_title"] = "Вы теперь саппортер!",
        ["settings.sup_thanks_sub"] = "Спасибо за поддержку AetherLove!",
        ["settings.sup_thanks_body"] = "Ваша поддержка помогает серверам работать. Наслаждайтесь новыми привилегиями!",
