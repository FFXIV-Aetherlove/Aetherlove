...
internal static class ChatRu
{
    public static readonly System.Collections.Generic.Dictionary<string, string> Strings = new()
    {
        ...
        ["chat.search_estimate"] = "Это может занять {0}-{1} секунд из-за количества переписок.",
        ["chat.search_rate_limited"] = "Слишком много переписок для поиска сразу. Повторите попытку через минуту.",
