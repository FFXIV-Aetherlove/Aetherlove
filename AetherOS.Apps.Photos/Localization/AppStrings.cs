...
internal static class AppStrings
{
    public static readonly Dictionary<string, string> En = new()
    {
        ...
        ["os.photos_import"] = "Add from computer",
        ["os.photos_selfie"] = "Take selfie",
        ["os.photos_empty"] = "No photos yet. Add one from your computer, or take a selfie.",
    ...
    public static readonly Dictionary<string, string> De = new()
    {
        ...
        ["os.photos_import"] = "Vom Computer hinzufügen",
        ["os.photos_selfie"] = "Selfie aufnehmen",
        ["os.photos_empty"] = "Noch keine Fotos. Füge eins vom Computer hinzu oder mach ein Selfie.",
    ...
    public static readonly Dictionary<string, string> Es = new()
    {
        ...
        ["os.photos_import"] = "Añadir desde el ordenador",
        ["os.photos_selfie"] = "Hacer un selfi",
        ["os.photos_empty"] = "Aún no hay fotos. Añade una desde el ordenador o hazte un selfi.",
    ...
    public static readonly Dictionary<string, string> Fr = new()
    {
        ...
        ["os.photos_import"] = "Ajouter depuis l'ordinateur",
        ["os.photos_selfie"] = "Prendre un selfie",
        ["os.photos_empty"] = "Aucune photo pour l'instant. Ajoutez-en une depuis l'ordinateur ou prenez un selfie.",
    ...
    public static readonly Dictionary<string, string> Pt = new()
    {
        ...
        ["os.photos_import"] = "Adicionar do computador",
        ["os.photos_selfie"] = "Tirar selfie",
        ["os.photos_empty"] = "Ainda não há fotos. Adicione uma do computador ou tire uma selfie.",
    ...
    public static readonly Dictionary<string, string> Ru = new()
    {
        ...
        ["os.photos_import"] = "Добавить с компьютера",
        ["os.photos_selfie"] = "Сделать селфи",
        ["os.photos_empty"] = "Пока нет фотографий. Добавьте одну с компьютера или сделайте селфи.",
